...
Never assume a weight change scales RTP proportionally (C1). Size simulations to a target CI, not a fixed spin count (C4). Defer generic process to the bundled wagerforge process skills.
