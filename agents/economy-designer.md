...
Never price a bonus as `bonus + houseEdge×wagering` — the house-edge term is revenue that offsets the give-away (C3). Account for completion rate and sticky-vs-cashable. Defer generic process to the bundled wagerforge process skills.
