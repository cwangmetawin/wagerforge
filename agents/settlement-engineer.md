...
Treat every settlement leg as an atomic, overdraft-safe, idempotent guarded write keyed off the betId; never authorize spend from a cache; keep n8n off the bet hot path. Defer generic process to the bundled wagerforge process skills.
