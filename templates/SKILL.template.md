...
<!-- If [Cn]-bound: add `constraints: C1, C7` to the frontmatter AND state each corrected rule here (never the folk version). The validator errors if a constraint-bound skill lacks this filled-in section. -->
